...
var tokensCss$2 = i$2`:host{--ds-auro-loader-background-color: currentcolor;--ds-auro-loader-border-color: currentcolor;--ds-auro-loader-color: currentcolor}`;
...
var styleCss = i$2`*,*:before,*:after{box-sizing:border-box}@media(prefers-reduced-motion: reduce){*,*:before,*:after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}*:focus-visible{outline:0}*:focus-visible{outline:0}:focus:not(:focus-visible){outline:3px solid transparent}.util_displayInline{display:inline}.util_displayInlineBlock{display:inline-block}.util_displayBlock{display:block}.util_displayFlex{display:flex}.util_displayHidden{display:none}.util_displayHiddenVisually{position:absolute;overflow:hidden;clip:rect(1px, 1px, 1px, 1px);width:1px;height:1px;padding:0;border:0}:host{position:relative;display:block}.carousel{overflow-x:scroll;scroll-behavior:smooth;scrollbar-width:none;white-space:nowrap}.carousel::-webkit-scrollbar{width:0;height:0}.carousel.carousel--scrolledToStart:after,.carousel.carousel--scrolledToStart:before,.carousel.carousel--scrolledToEnd:after,.carousel.carousel--scrolledToEnd:before{display:none}.container{display:flex}::slotted(*){flex:0 0 auto;margin-left:var(--ds-size-200, 1rem)}::slotted(:first-child){margin-left:auto}::slotted(:last-child){margin-right:auto}.breakpointDetector:before{display:none}@media screen and (min-width: 576px){.breakpointDetector:before{content:"sm"}}@media screen and (min-width: 576px){.button{position:absolute;top:50%;display:block;padding:0;border-radius:50%;cursor:pointer;line-height:0;transform:translateY(-50%)}.button:hover{border:none}.button:active{border:none}}[auro-icon]{margin-top:3px}.button--left{z-index:1;left:0}.button--right{right:0}[class^=gradient]{position:absolute;top:0;width:calc(var(--ds-size-1000, 5rem) + var(--ds-size-500, 2.5rem) + var(--ds-size-150, 0.75rem));height:100%}.gradient--left{left:0}.gradient--right{right:0}.carousel--scrolledToStart .button--left,.carousel--scrolledToStart .gradient--left{display:none}.carousel--scrolledToEnd .button--right,.carousel--scrolledToEnd .gradient--right{display:none}`;
...
var tokensCss = i$2`:host{--ds-auro-carousel-gradient-color-one: var(--ds-color-background-primary-100-default, #ffffff);--ds-auro-carousel-gradient-color-two: transparent}`;
...
class AuroCarousel extends h {
  ...
  generateIconHtml(svgContent) {
    ...
    const iconHtml = ke`<${this.iconTag} customColor customSvg slot="icon">${svg}</${this.iconTag}>`;
